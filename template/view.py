...
class View():
    ...
    '''
    def __init__(self,
        template_path="/home/yunqi/git_version/INFO2222-Group-Project/template/templates/",  # Path to template files
    ...
    def load_and_render(self, filename, header="header", **kwargs):
        '''
    ...
    def render(self, body_template, header_template, **kwargs):
        '''
            render
        ...
        # Join them
        rendered_template = rendered_head + rendered_body
